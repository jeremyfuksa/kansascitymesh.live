...
If you're on a hill, your node reaches farther. If you're in a valley, you might need to connect through someone on elevated ground. Look around and see if your house sits higher or lower than your neighbors.

For backbone router sites, I'm prioritizing locations that combine local elevation advantage, clear horizons, sustainable 24/7 access, and filling coverage gaps. Full topographic details are on the [coverage priorities page](/network/coverage).
