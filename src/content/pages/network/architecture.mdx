...
**Routers are reserved for partners who can combine significant elevation with reliable power and weatherized installs.** Misapplying router-style roles creates collisions and slows the network. Spend some time as a client first; think thrice before randomly assigning roles beyond Client.
