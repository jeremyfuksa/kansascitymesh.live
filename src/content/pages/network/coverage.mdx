...
<details>
<summary data-label-collapsed="Click to expand" data-label-expanded="Click to collapse">Understanding KC's topographic zones</summary>
...
<TopoContext title="Why Southern JoCo Works" icon="⛰️">
...
<TopoContext title="River Valley Crossing Strategy" icon="🌊">
...
<TopoContext title="South Metro Elevation Advantages" icon="🏔️">
...
<TopoContext title="Blue Ridge Tower Infrastructure" icon="📡">
