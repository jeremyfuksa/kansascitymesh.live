  ...
  - heading: Explore the network
    cards:
      ...
      - title: Network architecture
        description: Four-router backbone idea, device roles, and MQTT notes.
        link: /network/architecture
        linkText: Read the architecture notes
cta:
...
Jump to the coverage page for regional priorities or the architecture guide for the technical notes.
