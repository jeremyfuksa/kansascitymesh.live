...
24/7, well-placed routers with stable internet doing the uploads. Until those hosts come online, the Liberty Pi gateway handles the baseline logging. Long term the broker would ideally ride on a downtown high-rise or other central backbone site so the uplink lives at the heart of the mesh.
